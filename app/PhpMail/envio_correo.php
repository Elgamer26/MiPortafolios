...
class envio_correo
{
    function enviar_correo($correo, $html, $sms)
    {
        ...
        try {       //esto es una correccion para e nivel local
            ...
            $mail->Username = 'haciendamada@amada.i-sistener.xyz'; //este debe ir en el address?
            $mail->Password = 'HaciendAmada1.';                            // SMTP password
            $mail->SMTPSecure = 'ssl';         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
            $mail->Port       = 465;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

            //Recipients
            $mail->setFrom('haciendamada@amada.i-sistener.xyz', 'Portafolios Jorge Ramirez');
